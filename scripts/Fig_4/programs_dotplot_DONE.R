...
cell_types = c('acinar', 'ADM', 'ductal', 'ductal EMT', 'precursor lesion', 'cancer')     # cell types of interest on x-axis (sub-setting?)
...
dt_$cell_type[dt_$cell_type == 'precursor lesion'] = 'PanIN'
dt_$cell_type[dt_$cell_type == 'ductal EMT'] = 'DCLK1'
dt_$cell_type[dt_$cell_type == 'ductal'] = 'ductal/ductal-like'
...
ggsave(filename = 'programs_expression.pdf', width = 12, height = 10, units = 'in')
