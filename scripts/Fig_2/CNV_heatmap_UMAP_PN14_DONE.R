# this script plots CNV heatmap and UMAP for PN14 patient
...
jpeg(file = paste0('CNV_heatmap.png'), width = 1.7*h_, height = h_, units = 'in', res = 600, bg = 'black')
...
pdf(file = paste0('CNV_scatterplot.pdf'), width = 40, height = 40)
