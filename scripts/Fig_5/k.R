# This script carries out exocrine cell abundance analysis by Milo
...
da_results$cell_type[da_results$cell_type %in% c('ductal','ductal EMT')] = 'ductal/ductal-like/low-grade PanIN'
